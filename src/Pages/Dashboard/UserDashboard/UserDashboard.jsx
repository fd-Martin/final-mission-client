...
//           {/* Navbar */}
//           <nav className="navbar w-full bg-[#b58edf] text-white ">
//             <label
//               htmlFor="my-drawer-4"
...
//           ></label>
//           <div className="flex min-h-full flex-col items-start bg-[#070a39] text-white  is-drawer-close:w-14 is-drawer-open:w-64">
